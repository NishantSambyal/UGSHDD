...
public class Dashboard extends AppCompatActivity implements View.OnClickListener {
    ...
    void prepareList() {
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.main_pipe), "Used", "Auto Change", "Mainpipe", "688", "80-257-MPS-AUT-1U ", "Auto Change Kagla Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.main_pipe), "New", "Auto Change", "Mainpipe", "4779", "80-257-MPS-AUT-267 ", "Auto Change Itokoki", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.main_pipe), "Used", "Auto Change", "Mainpipe", "689", "80-257-MPS-AUT-2U ", "Auto Change Itokoki Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.fire_extinguisher_pipe), "New", "Fire Extinguisher", "Mainpipe", "934", "80-257-MPS-EXT-1 ", "1kg Fire Extinguisher", "267"));
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.fire_extinguisher_pipe), "New", "Fire Extinguisher", "Mainpipe", "936", "80-257-MPS-EXT-267 ", "Fire Extinguisher 267.5kg", "267"));
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.pigtail_pipe), "New", "Pigtail", "Mainpipe", "634", "89-275-MPS-PIG-267 ", "Pigtail POL (Vapour)", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.pigtail_pipe), "Used", "Pigtail", "Mainpipe", "635", "89-275-MPS-PIG-2U ", "Pigtail POL (Vapour) Used", "267"));
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.tee_check), "Used", "Tee Check", "Mainpipe", "691", "89-275-MPS-TEE-1U ", "Tee Check (No-Return Valve)Used", "267"));
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.regulator_pipe), "New", "Regulator", "Downpipe", "4878", "80-DPS-REG-0012 ", "Regulator BCF", "267"));
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "Used", "Bush", "Downpipe", "768", "89-274-DPS-BUS-1U ", "Bush MS ½ x? Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "New", "Bush", "Downpipe", "769", "89-274-DPS-BUS-267 ", "Bush GI ½ x¼", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "Used", "Bush", "Downpipe", "770", "89-274-DPS-BUS-2U ", "Bush GI ½ x¼ Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "New", "Bush", "Downpipe", "771", "89-274-DPS-BUS-3 ", "Bush GI ½ x¾", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "Used", "Bush", "Downpipe", "772", "89-274-DPS-BUS-3U ", "Bush GI ½ x¼ Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "New", "Bush", "Downpipe", "773", "89-274-DPS-BUS-4 ", "Bush Brass ¼ x?", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "Used", "Bush", "Downpipe", "774", "89-274-DPS-BUS-4U ", "Bush Brass ¼ x?  Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "New", "Bush", "Downpipe", "775", "89-274-DPS-BUS-5 ", "Bush MS ¼ x¾", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "Used", "Bush", "Downpipe", "776", "89-274-DPS-BUS-5U ", "Bush MS ¼ x¾  Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "New", "Bush", "Downpipe", "777", "89-274-DPS-BUS-6 ", "Bush Brass ¼ x?", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bush_downpipe), "Used", "Bush", "Downpipe", "778", "89-274-DPS-BUS-6U ", "Bush Brass ¼ x? Used", "267"));
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.ricecooker), "New", "Rice Cooker", "Burner", "446", "89-274-COK-RIC-7 ", "Rice Cooker Auto", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.ricecooker), "New", "Rice Cooker", "Burner", "447", "89-274-COK-RIC-8 ", "Rice Cooker Electronic Wire", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.ricecooker), "New", "Rice Cooker", "Burner", "448", "89-274-COK-RIC-9 ", "Rice Cooker Pilot", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.burner_stand), "New", "Stand", "Burner", "485", "89-274-COK-STD-1 ", "Kwali Stand Low 380mm", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.burner_stand), "Used", "Stand", "Burner", "486", "89-274-COK-STD-1U ", "Kwali Stand Low 380mm Used", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.burner_stand), "New", "Stand", "Burner", "487", "89-274-COK-STD-267 ", "Kwali Stand High 700mm", "267"));
        ...
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.toaster), "Used", "Toaster", "Burner", "2445", "89-274-COK-TOA-2U ", "RINNAI TOASTER GLASS USED", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.toaster), "New", "", "Burner", "4748", "89-4--0 ", "", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bowl_ring), "New", "Bowl & Ring", "Burner", "4648", "89-4-59-0017 ", "", "267"));
        inventoryItems.add(new InventoryItem(convertIntoByte(R.drawable.bowl_ring), "New", "Bowl & Ring", "Burner", "4649", "89-4-59-0018 ", "", "267"));
