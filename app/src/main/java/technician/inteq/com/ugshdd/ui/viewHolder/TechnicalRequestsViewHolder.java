...
public class TechnicalRequestsViewHolder extends ParentViewHolder {
    ...
    public TechnicalRequestsViewHolder(@NonNull View itemView) {
        super(itemView);
        item = (TextView) itemView.findViewById(R.id.outlet);
        arrowImage = (ImageView) itemView.findViewById(R.id.arrowImage);
    }

    public void bind(TechnicalRequests requests) {
        item.setText(requests.getTechnicalRequest());
    }
