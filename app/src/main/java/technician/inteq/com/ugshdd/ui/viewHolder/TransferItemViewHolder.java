...
public class TransferItemViewHolder extends ParentViewHolder {
    ...
    public TransferItemViewHolder(@NonNull View itemView) {
        super(itemView);
        item = (TextView) itemView.findViewById(R.id.outlet);
        arrowImage = (ImageView) itemView.findViewById(R.id.arrowImage);
    }

    public void bind(TransferItem outlets) {
        item.setText(outlets.getTransferItemName());
    }
